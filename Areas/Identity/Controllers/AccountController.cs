...
namespace App.Areas.Identity.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> SendCode(string? returnUrl = null, bool rememberMe = false)
        {
            ...
            return View(new SendCodeViewModel { Providers = factorOptions, ReturnUrl = returnUrl ?? Url.Content("~/"), RememberMe = rememberMe });
        }
        //
        ...
        public async Task<IActionResult> VerifyCode(string provider, bool rememberMe, string? returnUrl = null)
        {
            ...
            return View(new VerifyCodeViewModel { Provider = provider, ReturnUrl = returnUrl ?? Url.Content("~/"), RememberMe = rememberMe });
        }
        ...
        public async Task<IActionResult> VerifyAuthenticatorCode(bool rememberMe, string? returnUrl = null)
        {
            ...
            return View(new VerifyAuthenticatorCodeViewModel { ReturnUrl = returnUrl ?? Url.Content("~/"), RememberMe = rememberMe });
        }
        ...
        public async Task<IActionResult> UseRecoveryCode(string? returnUrl = null)
        {
            ...
            return View(new UseRecoveryCodeViewModel { ReturnUrl = returnUrl ?? Url.Content("~/") });
        }
